/**
 * TripDetailScreen - Edit Trip Information with Map View
 * 
 * This screen shows a GPS map with the trip route and allows users to edit
 * trip details including classification, miles, and notes.
 */
...
import { IRS_RATES_CENTS, TripType } from '../features/mileage/config';
    ...
    <View className="flex-1 bg-slate-950">
      <View style={{ height: 320 }}>
        <MapView ref={mapRef} style={{ flex: 1 }} initialRegion={{
          ...
          {coords.length >= 2 && <Polyline coordinates={coords} strokeColor="#3b82f6" strokeWidth={4} />}
