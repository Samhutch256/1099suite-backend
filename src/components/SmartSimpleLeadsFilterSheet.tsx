...
interface SmartSimpleLeadsFilterSheetProps {
  visible: boolean;
  onClose: () => void;
  onApply: (filters: SmartSimpleFilters) => void;
  currentFilters: SmartSimpleFilters;
}
...
export const SmartSimpleLeadsFilterSheet: React.FC<SmartSimpleLeadsFilterSheetProps> = ({
  visible,
  onClose,
  onApply,
  currentFilters,
}) => {
  const [localFilters, setLocalFilters] = useState<SmartSimpleFilters>(currentFilters);
  ...
  const sourceOptions = [
    ...
    { value: 'door_knocks', label: 'Door Knock', color: 'green' },
    { value: 'referrals', label: 'Referral', color: 'purple' },
    { value: 'calls_made', label: 'Calls', color: 'orange' },
    { value: 'tags_put', label: 'Tags', color: 'teal' },
    { value: 'ads', label: 'Ads', color: 'red' },
    ...
    >
      <View className="flex-1 bg-black/50">
        <View className="flex-1 justify-end">
          <View className="bg-white rounded-t-3xl" style={{ maxHeight: '80%', minHeight: '50%' }}>
            {/* Header */}
            ...
            >
              ...
              {/* Sources Section */}
              <View className="mb-6">
                <Text className="text-lg font-semibold text-gray-900 mb-3">Lead Sources</Text>
