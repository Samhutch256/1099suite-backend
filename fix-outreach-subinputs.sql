-- Fix for Outreach Attempts subinput persistence issue
-- Root cause: daily_inputs_sum_range_with_subinputs was missing doors_knocked column
-- This caused all returned columns to be misaligned with frontend expectations
