...
app.post('/api/jessica-chat-message', async (req, res) => {
  ...
  try {
    ...
    if (forceAI) {
      ...
      try {
        const systemPrompt = `You are Jessica, a helpful assistant who supports users with lead input, KPIs, appointments, business operations, and financial transaction management. Respond naturally and flexibly like ChatGPT. Always infer context and help with initiative.
